...
export const ui = {
  ja: {
    ...
    'skills.lang_and_frameworks': '言語 & フレームワーク',
    'skills.other_languages': 'その他の言語',
  ...
  en: {
    ...
    'skills.lang_and_frameworks': 'Languages & Frameworks',
    'skills.other_languages': 'Other Languages',
